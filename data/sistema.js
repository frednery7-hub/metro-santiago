const SISTEMA = {
  ...
  L2: {
    ...
    estacoes: [
      ...
      'San Miguel','Lo Vial','Departamental','Ciudad del Nino','Lo Ovalle',
      'El Parron','La Cisterna','Observatorio','Lo Martinez',
      'Hospital El Pino'
    ]
  },
  L3: {
    ...
    estacoes: [
      ...
      'Plaza Chacabuco','Hospitales','Puente Cal y Canto',
      'Plaza de Armas','Universidad de Chile','Parque Almagro',
      'Matta','Irarrazaval','Monsenor Eyzaguirre','Nunoa',
      'Chile Espana','Villa Frei','Plaza Egana',
  ...
  L4: {
    ...
    estacoes: [
      ...
      'Los Presidentes','Quilin','Las Torres','Macul',
      'Vicuna Mackenna','Vicente Valdes','Rojas Magallanes',
      'Trinidad','San Jose de la Estrella','Los Quillayes',
      'Elisa Correa','Hospital Sotero del Rio',
  ...
  L4A: {
    ...
    estacoes: [
      'Vicuna Mackenna','Santa Julia','La Granja',
      'Santa Rosa','San Ramon','La Cisterna'
    ]
  },
  L5: {
    ...
    estacoes: [
      ...
      'Bellas Artes','Baquedano','Parque Bustamante',
      'Santa Isabel','Irarrazaval','Nuble','Rodrigo de Araya',
      'Carlos Valdovinos','Camino Agricola','San Joaquin',
      'Pedrero','Mirador','Bellavista de la Florida',
      'Vicente Valdes'
    ]
  },
  L6: {
    ...
    estacoes: [
      ...
      'Franklin','Bio Bio','Nuble','Estadio Nacional',
...
const SIGLAS = {
  ...
  'SAL':'Salvador',              'MMO':'Manuel Montt',
  'QUI':'Quilin',                'MAC':'Macul',
  'NBL':'Nuble',                 'IRR':'Irarrazaval',
  'NUN':'Nunoa',                 'PDA':'Plaza de Armas',
  'BEL':'Bellas Artes',          'PAC':'Presidente Pedro Aguirre Cerda',
  'LVA':'Lo Valledor',           'SAR':'San Ramon',
  'DEP':'Departamental',         'HEP':'Hospital El Pino',
  'LLI':'Los Libertadores',      'FCS':'Fernando Castillo Velasco',
  'CER':'Cerrillos',             'ULA':'Union Latinoamericana',
  'USA':'Universidad de Santiago','UCA':'Universidad Catolica',
  'BIO':'Bio Bio',               'PQO':'Parque OHiggins',
  'LVI':'Lo Vial',               'OBS':'Observatorio',
  'LMZ':'Lo Martinez',           'PLQ':'Plaza Chacabuco'
};
...
const SEM_ELEVADOR = new Set([
  'Neptuno','Dorsal','Santiago Bueras','Del Sol',
  'Cardenal Caro','Vivaceta','Conchali','Plaza Chacabuco',
  'Lo Valledor','San Ramon','Departamental','Lo Vial',
  'Observatorio','Lo Martinez'
]);
...
module.exports = {
  SISTEMA, SIGLAS, TEMPO_LINHA, TEMPO_BALDEACAO,
  ALERTAS, SEM_ELEVADOR, OPERACAO
};
